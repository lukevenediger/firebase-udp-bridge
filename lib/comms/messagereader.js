...
function MessageReader(buffer, offset) {
    ...
    this.validatePacketStart = function() {
        ...
        offset += DataTypeSizes.CONTROL_CODE;
    ...
    this.readUInt64 = function() {
        var value = buffer.readUIntLE(offset, DataTypeSizes.UINT_64);
    ...
    this.readFloat = function() {
        var value = buffer.readFloatLE(offset, offset + DataTypeSizes.FLOAT);
        offset += DataTypeSizes.FLOAT;
        return value;
    };
    ...
    this.readBoolean = function() {
        var value = buffer.readUIntLE(offset, DataTypeSizes.BOOLEAN);
