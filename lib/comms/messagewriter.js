...
function MessageWriter() {
    ...
    this.writePacketStart = function() {
        var buffer = new Buffer(DataTypeSizes.CONTROL_CODE);
        buffer.writeInt16LE(ControlCodes.PACKET_START);
    ...
    this.writeInt16 = function(value) {
        ...
        var buffer = new Buffer(DataTypeSizes.INT_16);
    ...
    this.writeInt32 = function(value) {
        ...
        var buffer = new Buffer(DataTypeSizes.INT_32);
    ...
    this.writeUInt64 = function(value) {
        ...
        buffer.fill(0);
        buffer.writeUIntLE(value, 0, DataTypeSizes.UINT_64);
        saveToMainBuffer(buffer);
        return this;
    };
    ...
    this.writeFloat = function(value) {
        // normalise the value
        value = value || 0;
        var buffer = new Buffer(DataTypeSizes.FLOAT);
    ...
    this.writeBoolean = function(value) {
        ...
        buffer.writeUIntLE(value ? 1 : 0, 0, 1);
        saveToMainBuffer(buffer);
        return this;
    };
